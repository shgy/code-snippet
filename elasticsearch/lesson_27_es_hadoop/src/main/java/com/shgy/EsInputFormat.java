...
class EsReader<K,V> extends RecordReader<K, V> {
    private int index=0;
    ...
    public K getCurrentKey() throws IOException, InterruptedException {
        return (K)new LongWritable(index);
    }

    @Override
    public V getCurrentValue() throws IOException, InterruptedException {
        return (V)new Text(data[index++]);
...
public class EsInputFormat<K,V> extends FileInputFormat<K,V> {
