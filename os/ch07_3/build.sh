...
gcc -m32 -I lib/kernel/ -I lib/ -I kernel/ -c -fno-stack-protector -o build/timer.o device/timer.c
...
ld -m elf_i386 -Ttext 0x10000 -e main -o build/kernel.bin \
   build/main.o build/init.o build/interrupt.o build/print.o build/kernel.o build/print_int.o build/timer.o
